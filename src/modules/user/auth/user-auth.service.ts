...
import { SignInRes, SignUpRes, TokenPayload } from './interface/auth.interface';

@Injectable()
export class UserAuthService {
  constructor(private readonly jwtService: JwtService) {}

  async signUp(data: SignUpDto): Promise<BaseResponse<SignUpRes>> {
    try {
  ...
  async signIn(data: SignInDto): Promise<BaseResponse<SignInRes>> {
    try {
